...
const AccountSettingsPage = () => {
  ...
  // Configure Yup locale and memoize schema
  const normLocale =
  ...
  const userData = user?.onboardedDetails?.invitedBy;
  const subRole = toCamelCase(userData?.subRole);

  return (
    <div className="flex flex-col min-h-screen">
      <div className="md:flex flex-1 bg-gray-50">
        <SettingsSidebar role={user.role} />

        {user && user?.onboardedDetails?.invitedBy ? (
          <div className="w-full px-3 py-6 lg:p-6 max-w-4xl">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">
                    {userData?.[subRole]?.name}
                  </h3>
                  <p className="text-gray-600">
                    {t("invitedBy")}: {userData?.email}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full px-3 py-6 lg:p-6 max-w-4xl mx-auto">
            <div className="mb-8">
            ...
            {user && user?.onboardedDetails?.subRole === "team" && (
              <>
                <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">
                      ...
                      {pagination.length === 1 ? "member" : "members"}
                    </span>
                  </div>
